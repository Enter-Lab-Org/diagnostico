    ...
    return (
        ...
        <div className="flex flex-col gap-5 text-gray-400">
            ...
            <div className="flex flex-row gap-9 justify-center items-center">
                <Link href={APP_ROUTES.PERFIL_EMPRESAS} className="subTitle textPurple botonPurpleLine text-center p-2 px-24">Registrar nueva empresa</Link>
                <button className="subTitle textPurple botonPurpleLine p-2 border-2 px-24">Empresas registradas</button>
            </div>
        </div>
    );
}
