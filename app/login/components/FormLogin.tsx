            ...
            <div className="grid grid-cols-2">
                ...
                <div className="flex flex-col align-center justify-center items-center p-14">
                    ...
                    <form className="flex flex-col gap-4 w-full mt-10">
                        ...
                        <button type="submit" className="bg-blue-900 text-white p-2 rounded-xl border-blue-900 border-2 w-full font-extrabold">Iniciar sesión</button>
                ...
                <div className="flex flex-col bg-gray-300 rounded-xl align-center justify-center items-center p-14 gap-9">
                    <h1 className="text-blue-900 text-2xl font-extrabold text-center">Empieza tu diagnóstico</h1>
                    <p>
